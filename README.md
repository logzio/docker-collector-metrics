...
| LOGZIO_REGION | Your Logz.io account's region. Omit for US East. For more information on finding your account's region, see [Account region](https://docs.logz.io/user-guide/accounts/account-region.html). |
